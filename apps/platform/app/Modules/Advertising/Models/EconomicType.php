...
class EconomicType extends Model
{
     ...
     * complète — un retrait rapproché (`AdminEconomicTypesController::store`)
     * pouvait alors produire un `effective_to` tronqué antérieur au
     * `effective_from` de la même seconde et violer la contrainte
     * `economic_types_period_check`.
     */
