...
/**
 * Ajoute `campaign.fund_self` au rôle modèle `user.base` (véto du dirigeant,
 * 2026-07-30) — même mécanisme générique que `wallet.deposit`/
 * `campaign.create` : toute personne inscrite reçoit cette capacité dès
 * l'inscription (`GrantAutoIssuer`), sans octroi manuel.
 */
return new class extends Migration
{
    private const CAPABILITY_KEY = 'campaign.fund_self';
