...
/**
 * Ajoute `advertiser_wallet.allocate` au rôle modèle `user.base` (instruction
 * explicite du fondateur, 2026-07-31) — même mécanisme générique que
 * `advertiser_wallet.deposit` ci-dessus.
 */
return new class extends Migration
{
    private const CAPABILITY_KEY = 'advertiser_wallet.allocate';
