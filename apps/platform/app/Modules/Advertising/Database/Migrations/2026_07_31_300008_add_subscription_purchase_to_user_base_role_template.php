...
/**
 * Ajoute `subscription.purchase` au rôle modèle `user.base` (instruction
 * explicite du fondateur, 2026-07-31) — même mécanisme générique que
 * `advertiser_wallet.deposit`/`campaign.fund_self`.
 */
return new class extends Migration
{
    private const CAPABILITY_KEY = 'subscription.purchase';
