...
/**
 * Ajoute `advertiser_wallet.deposit` au rôle modèle `user.base` (instruction
 * explicite du fondateur, 2026-07-31) — même mécanisme générique que
 * `campaign.fund_self`/`wallet.deposit` : toute personne inscrite reçoit
 * cette capacité dès l'inscription (`GrantAutoIssuer`), sans octroi manuel.
 */
return new class extends Migration
{
    private const CAPABILITY_KEY = 'advertiser_wallet.deposit';
