...
/**
 * Portail personnel Wasplex (DS-0001 §19 « Administration : priorité à
 * état du système, files d'approbation, risques, audit et
 * configuration »), UX-0001 §8/§9. Desktop primaire, même structure que
 * `AdvertiserLayout` (tiroir mobile via `Sheet`) — vouvoiement (DS-0001
 * §28).
 *
 * Aucun badge de rôle générique (« Super Admin » ou équivalent) : le
 * système ne connaît aucun rôle admin monolithique, seulement des
 * capacités indépendantes par personne (ADR-0004) — afficher un tel badge
 * inventerait une identité que le modèle de données ne porte pas.
 */
            ...
            <div className="flex min-w-0 flex-1 flex-col">
                <header className="sticky top-0 z-20 flex items-center gap-3 border-b border-[var(--border-default)] bg-[var(--bg-surface)] px-4 py-3 sm:px-6">
                    ...
                    <div className="flex shrink-0 items-center gap-3">
                        <div className="hidden items-center gap-2 py-1 pr-1 pl-2 text-sm font-medium text-[var(--text-primary)] sm:flex">
