...
export default function MobileLayout({
    ...
    return (
        <div className="min-h-svh bg-[#07182D]">
            {/* DS-0001 §13 : desktop n'étire pas le mobile — la vue reste
                contenue dans une colonne de largeur téléphone, centrée sur
                un fond identique au reste de l'écran. */}
            <div className="mx-auto flex min-h-svh w-full max-w-[480px] flex-col text-[#F5F8FC]">
                {showHeader && (
                ...
                <main
                    className={['flex-1', fullScreen ? '' : 'pb-20'].join(' ')}
                >
                    {children}
                </main>
            </div>
