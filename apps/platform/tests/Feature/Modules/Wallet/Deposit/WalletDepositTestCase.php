...
namespace Tests\Feature\Modules\Wallet\Deposit;
...
abstract class WalletDepositTestCase extends TestCase
{
    ...
    /**
     * Construit un payload de webhook GeniusPay signé valide (documentation
     * prestataire « Sécurité des webhooks »).
     *
