...
## Article 16 — Identité proportionnée et antifraude équitable

1. Wasplex distingue l'existence d'un compte, l'identité déclarée, l'identité vérifiée, l'unicité suffisante, le contrôle actuel du compte et l'autorisation d'une opération.
2. L'accès de base reste inclusif ; plus une opération engage valeur, responsabilité, sécurité ou pouvoir, plus la preuve exigée est forte.
3. Un utilisateur au canal confirmé peut accumuler des gains provisoires dans une limite annoncée avant KYC complet.
4. Le KYC conditionne la disponibilité ou le déplacement de la valeur selon le risque ; il n'autorise pas l'effacement silencieux d'une valeur légitime déjà créée.
5. Téléphone, e-mail, document, appareil, IP, biométrie ou moyen de paiement ne prouvent jamais seuls l'identité, l'unicité et l'autorisation de toute opération.
6. L'absence de document officiel n'exclut pas des fonctions essentielles. Des parcours alternatifs, progressifs, contrôlés et périodiquement réexaminés sont prévus.
7. Une organisation vérifiée est un statut séparé du niveau individuel ; chaque représentant demeure nominatif, vérifié, habilité et audité.
8. Un appareil ou réseau partagé est un indicateur de risque, non une preuve automatique de fraude.
9. Les doublons accidentels, comptes perdus, usages familiaux et comptes multiples frauduleux sont distingués avant sanction.
10. Toute suspicion est graduée : anomalie, suspicion faible, suspicion sérieuse, fraude confirmée ou compte compromis.
11. Toute restriction est nécessaire, ciblée, motivée, datée, réexaminée et contestable.
12. Les gains légitimes et fonctions sans lien restent protégés autant que le risque le permet.
13. Une enquête ne transforme pas automatiquement tous les gains disponibles en gains frauduleux.
14. Une fraude confirmée annule la valeur frauduleuse par écritures traçables. Un montant déjà retiré devient, le cas échéant, une créance documentée et non un Wallet négatif créé silencieusement.
15. Le titulaire honnête d'un compte compromis est distingué de l'auteur des opérations frauduleuses.
16. Aucun score antifraude ne prononce seul une sanction importante ; une responsabilité humaine et un recours existent.
17. Toute mesure provisoire possède une échéance de revue ; aucune suspension indéfinie sans décision n'est autorisée.
18. L'authentification du compte et l'autorisation d'une opération sont distinctes.
19. Une opération sensible exige une authentification récente et des facteurs indépendants proportionnés au risque.
20. SMS, e-mail, contact de confiance, questions personnelles ou connaissance de l'historique ne permettent pas seuls la récupération d'un compte de forte valeur.
21. La biométrie locale de l'appareil peut protéger une clé sans transmettre de donnée biométrique à Wasplex ; tout autre traitement reste soumis à l'article 8.
22. Perte d'appareil, changement de numéro ou récupération ne suppriment ni compte ni gains et déclenchent des protections temporaires proportionnées.
...
2. Une règle constitutionnelle prime sur toute spécification, maquette, implémentation ou prompt.
3. Une hypothèse doit être étiquetée comme telle.
4. Une contradiction doit être enregistrée et résolue explicitement.
5. Une valeur économique doit avoir une source, une destination et une formule auditables.
